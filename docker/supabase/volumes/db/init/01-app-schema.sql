...
-- AI usage ledger (service-role only)
-- The auth.users foreign key is added by hosted migrations. GoTrue creates
-- auth.users after this Docker init script runs, so it cannot be declared here.
